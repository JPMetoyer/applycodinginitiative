...
<style lang="scss">
    ...
    div.deliverable {
        ...
        @keyframes primary-in {
            ...
            100% {
                transform: translateX(-48%) translateY(-50%) rotateZ(368deg);
            }
        ...
        @keyframes secondary-in {
            ...
            100% {
                transform: translateX(-45%) translateY(-54%) rotateZ(350deg);
            }
        }   
        ...
        @keyframes tertiary-in {
            ...
            100% {
                transform: translateX(-38%) translateY(-50%) rotateZ(374deg);
            }
        ...
        @keyframes quaternary-in {
            ...
            100% {
                transform: translateX(-45%) translateY(-44%) rotateZ(364deg);
            }
        }   
