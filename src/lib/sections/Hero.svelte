    ...
    section#hero {
        ...
        div.controls {
            ...
            div.pagination {
                ...
                span { position: relative; width: 0.3rem; height: 0.3rem; background-color: app.$color-gray; border-radius: 2rem; }
...
<section id="hero">
    ...
    <div class="controls">
        ...
        { #each projects.slice(0, 4) as _, index }
        ...
        <div class="arrows">
            ...
            <Icon handleClick={ () => { focusIndex++; if (autoToggle) { autoToggle = false;  }} } disabled={ focusIndex === (projects.slice(0, 4).length - 1) }>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
